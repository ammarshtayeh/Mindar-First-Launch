      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div className="space-y-4">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-cairo">
            حوّل ملفاتك ومحاضراتك إلى اختبارات ذكية وبطاقات استذكار في ثوانٍ
            معدودة باستخدام الذكاء الاصطناعي.
          </p>
        </div>

        {/* Quick Links / Services */}
        <div className="space-y-4">
          <h3 className="text-lg font-bold text-zinc-900 dark:text-white font-cairo">
            روابط سريعة
          </h3>

...
export function VennDiagram() {
  ...
  return (
    <div className="py-20 md:py-32 relative overflow-hidden" dir="rtl">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[800px] h-[300px] md:h-[800px] bg-blue-900/10 rounded-full blur-[60px] md:blur-[100px] pointer-events-none" />

      <div className="text-center mb-10 md:mb-20 relative z-10">
        <h2 className="text-3xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-slate-300 mb-4 md:mb-6 font-primary">
          نقطة الالتقاء
        </h2>
        <p className="text-slate-400 max-w-2xl mx-auto px-4 text-base md:text-lg font-light leading-relaxed">
      ...
      <div className="lg:hidden flex flex-col items-center gap-6 px-4">
          <div className="relative mb-8">
               <div className="relative bg-black/40 backdrop-blur-xl text-white px-8 py-3 rounded-full border border-white/20 shadow-lg">
                <span className="font-bold text-2xl bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                    MINDAR
                </span>
              </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl">
              {circles.map((circle, index) => (
                  <motion.div
                      ...
                      className={`
                        p-6 rounded-2xl bg-gradient-to-br ${circle.color} 
                        backdrop-blur-sm border border-white/10 shadow-xl 
                        ${circle.shadow} flex items-center justify-center text-center
                        min-h-[160px]
                      `}
                  >
                      <span className="text-white/90 font-bold text-lg leading-snug drop-shadow-md">
                        {circle.label}
                      </span>
                  </motion.div>
              ))}
      ...
      <div className="hidden lg:flex h-[600px] items-center justify-center relative perspective-1000">
        <div className="relative w-[500px] h-[500px]">
          {circles.map((circle, index) => {
            ...
            <motion.div
              ...
              className="absolute top-1/2 left-1/2 -ml-36 -mt-36 z-10"
            ...
            >
                <motion.div
                  ...
                  className={`w-72 h-72 rounded-full bg-gradient-to-br ${circle.color} backdrop-blur-sm border border-white/20 flex items-center justify-center text-center p-6 shadow-2xl ${circle.shadow} hover:scale-110 transition-all duration-500 cursor-default ${isBlurred ? 'opacity-30 blur-sm grayscale scale-95' : 'opacity-100 scale-100'}`}
                  style={{ mixBlendMode: 'plus-lighter' }}
                >
                    <div className="relative z-10">
                        <span className="block text-white/90 font-bold text-xl whitespace-pre-line drop-shadow-lg leading-tight">
                            {circle.label}
                        </span>
          ...
          >
            <div className="relative group cursor-pointer">
              ...
              <div className="relative bg-black/40 backdrop-blur-xl text-white px-8 py-4 rounded-full border border-white/20 shadow-[0_0_50px_rgba(255,255,255,0.15)] group-hover:scale-110 transition-transform duration-300">
                <span className="font-bold text-3xl bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                    MINDAR
                </span>
              </div>
            </div>

...
const variantsStyles = {
  ...
  destructive: "bg-red-500 text-white hover:bg-red-600 shadow-[0_0_20px_rgba(239,68,68,0.3)] border border-red-500/50",
...
export const buttonVariants = ({ variant = "default", size = "default", className = "" } : { variant?: keyof typeof variantsStyles | null, size?: keyof typeof sizeStyles | null, className?: string } = {}) => {
  return cn(

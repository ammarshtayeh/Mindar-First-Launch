...
export function ActivitySettingsModal({
  isOpen,
  onClose,
  onStart,
  type,
}: ActivitySettingsModalProps) {
  ...
  const quizTypes = [
    {
      id: "multiple-choice",
      label: language === "ar" ? "اختيار من متعدد" : "Multiple Choice",
    },
    {
      id: "true-false",
      label: language === "ar" ? "صح أو خطأ" : "True / False",
    },
    {
      id: "fill-in-the-blanks",
      label: language === "ar" ? "أكمل الفراغ" : "Fill in the Blanks",
    },
    {
      id: "explanation",
      label: language === "ar" ? "شرح / سؤال مقالي" : "Explanation / Essay",
    },
  ];
                    ...
                    {quizTypes.map((t) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div
                            className={`w-5 h-5 rounded-lg border-2 flex items-center justify-center transition-all duration-300 ${isSelected ? "bg-primary border-primary scale-110 shadow-lg shadow-primary/20" : "border-muted-foreground/30 group-hover:border-primary/50"}`}
                          >
                            {isSelected && (
              ...
              {type === "checklist" && (
                <div className="py-6 text-center">
                  <p className="text-xl font-bold text-primary italic">
                    {language === "ar"
                      ? "الذكاء الاصطناعي سيقوم بتحويل مادتك إلى خطة عمل ذكية"
                      : "AI will transform your material into a smart action plan"}
                  </p>
                </div>
              )}
            </div>

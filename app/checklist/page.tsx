        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
                ...
                <h1 className="text-5xl md:text-7xl font-black tracking-tighter">
                   {language === 'ar' ? 'خططك <span className="text-primary italic">الذكية</span> 📋' : 'Your <span className="text-primary italic">Smart</span> Plans 📋'}
                </h1>
            </div>
        ...
        {checklists.length === 0 ? (
          <div className="py-20">
            <CreativeEmptyState 
              ...
              description={language === 'ar' ? 'ابدأ برفع مادة دراسية في الـ Hub وتوليد خطة ذكية.' : 'Start by uploading material in the Hub and generating a smart plan.'}
            />
            <div className="mt-8 text-center">
                <Button onClick={() => router.push('/hub')} className="h-16 px-10 rounded-[2rem] font-black text-lg gap-3 shadow-xl">

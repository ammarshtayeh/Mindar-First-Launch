...
import { ArrowLeft, Save, Share2, Download, Home } from "lucide-react";
      ...
      const traverse = (
        ...
        const palette =
          level === 0
            ...
            : colorPalettes[branchIndex % colorPalettes.length];
      ...
      <div className="flex items-center justify-between p-4 bg-background/80 backdrop-blur-md border-b border-border z-10">
        <div className="flex items-center gap-4">
          <Button
            variant="outline"
            onClick={() => router.back()}
            className="flex items-center gap-2 rounded-2xl border-2 border-primary/10 hover:border-primary/20 bg-background/50 font-black h-11 px-5"
          >
            <ArrowLeft
          ...
          <Button
            ...
            className="rounded-full hover:bg-muted w-11 h-11"
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            size="sm"
            className="flex items-center gap-2 rounded-full shadow-lg shadow-primary/20"
          >

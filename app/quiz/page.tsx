...
interface Question {
    id: number;
    type: 'multiple-choice' | 'true-false' | 'fill-in-the-blanks' | 'explanation' | 'coding';
    question: string;
    options?: string[];
    answer: string;
    explanation?: string;
...
export default function QuizPage() {
    ...
    const isCoding = ['coding', 'code', 'programming'].includes(qType) || (currentQuestion as any).isCoding || ((currentQuestion as any).codeSnippet && ['short-answer', 'explanation'].includes(qType));
    const isExplain = ['explanation', 'essay', 'short-answer', 'short_answer', 'open-ended', 'descriptive'].includes(qType) && !isCoding;
                ...
                <Card className="bg-card/50 backdrop-blur-xl border-border/50 shadow-2xl rounded-[3rem] overflow-hidden">
                    <CardHeader className="p-6 sm:p-10 md:p-16 pb-6 md:pb-8">
                        ...
                        {(currentQuestion as any).codeSnippet && (
                            <div className="mt-8 mx-auto w-full max-w-2xl bg-[#1e1e1e] rounded-2xl overflow-hidden shadow-2xl border-4 border-slate-800 text-left" dir="ltr">
                                                ...
                                                <div className="mt-8 text-left" dir="ltr">
                                                    ...
                                                    <div className="bg-[#1e1e1e] rounded-xl overflow-hidden border-2 border-green-500/20 shadow-lg relative group">
                                                        <div className="flex items-center justify-between px-4 py-2 bg-[#252526] border-b border-[#3e3e42]">
                                                            <span className="text-xs text-green-400 font-mono">solution.js</span>
